// Illustrator JSX script – place PNG and EPS side by side with same height
// ----------------------------------------------------------------------
...
(function () {
    ...
    function initLog() {
        ...
        logFile.open("w");
        logFile.writeln("=== DIAL4.JSX DEBUG LOG ===");
    ...
    try {
        ...
        alert("Artwork placed side by side. Check log.txt for details.");
