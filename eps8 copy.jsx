...
try {
    ...
    if (!imgFile.exists) {
        ...
        // Resize first image to 150 x 300
        img1.width = 150;
        img1.height = 300;
        
        alert("✅ First image resized to 150 x 300");
        logToFile("First image resized to 150 x 300");
        ...
        // Resize second image to 150 x 300
        img2.width = 150;
        img2.height = 300;
        
        alert("✅ Second image resized to 150 x 300");
        logToFile("Second image resized to 150 x 300");
        ...
        alert("🎉 SUCCESS!\nBoth images (150x300) should now be visible side by side.\nFirst image at 100, Second image at 300");
        logToFile("SUCCESS! Both images (150x300) should now be visible side by side. First image at 100, Second image at 300");
    }
